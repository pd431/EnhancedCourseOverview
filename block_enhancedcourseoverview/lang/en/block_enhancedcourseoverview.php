...
<strong>Default filters:</strong> Add "|default" to the end of a filter line to have it already selected when a user opens their dashboard, e.g. "Term 2|_*2*_202526|default". Any pipe characters inside the pattern itself (e.g. regex alternation like "/_(A|B)_2_202425/") are left alone - only a trailing "|default" is treated specially.<br><br>
