...
$plugin->version   = 2025031417;         // The current plugin version (Date: YYYYMMDDXX).
$plugin->requires  = 2024100100;         // Requires this Moodle version.
$plugin->component = 'block_enhanced_course_overview'; // Full name of the plugin (used for diagnostics).
$plugin->dependencies = [
    'block_myoverview' => 2024100100     // The Enhanced Course Overview block depends on the My Overview block.
];
